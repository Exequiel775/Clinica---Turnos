    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                perfil = new Perfil_1.Perfil();
                perfil.descripcion = formData.get('Descripcion').toString();
                return [4 /*yield*/, AgregarPerfil(perfil)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
function AgregarPerfil(perfil) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _perfilServicio.Add(perfil)];
                case 1:
                    response = _a.sent();
                    if (!response.estado) {
                    ...
                    input = document.getElementsByName('Descripcion')[0];
                    input.value = '';
                    return [2 /*return*/];
            }
        });
...
//# sourceMappingURL=VistaNuevoPerfil.js.map